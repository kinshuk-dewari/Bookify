...
const uri = "mongodb+srv://Bookify:74HEhLfc3uCzPRTQ@demo.mnzvhvf.mongodb.net/?retryWrites=true&w=majority";
...
async function run() {
  try {
    ...
    app.delete("/book/:id",async(req,res)=>{
        ...
        const results = await booksCollection.deleteOne(filter);
        res.send(results);
    })
